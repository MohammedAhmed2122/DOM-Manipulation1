...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  mainTitleElement.textContent = "Welcome to Dom's world";
  //Part 2
  ...
  newRace.textContent = "New Jersey";
  ...
  //add text
  blogPostH2.textContent = "New Jersey ";
  blogPost.appendChild(blogPostH2);

  let blogPostP = document.createElement("p");
  blogPostP.textContent = "I picked up my girl and drove to McDonalds ".toLocaleUpperCase();
  ...
  blogpostArr.forEach(function (post) {
    post.addEventListener(
      "mouseout",
      function (e) {
        post.setAttribute("class", "blog-post gray");
      },
      false
    );
    post.addEventListener(
